...
const { expect } = require("chai"); // permet de tester evenement
const ERC20 = artifacts.require("ERC20Token"); //permet de recupérer erc20 class

contract("ERC20", function (accounts) {
  // contract prmet de dire qu'on a tester un contrat avec la liste des compte providers web3
  const _name = "ALYRA";
  const _symbol = "ALY";
  ...
  beforeEach(async function () {
    // deploiement ERC20 avant chaque test dans beforceEach pour minimiser le code
